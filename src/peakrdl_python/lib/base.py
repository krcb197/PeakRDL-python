...
import logging
from typing import Dict, List, Optional, Tuple, Union, cast, Iterator, TYPE_CHECKING, Type, \
...
class NodeArray(Base, Sequence[Union[NodeArrayElementType, 'NodeArray'[NodeArrayElementType]]]):
    """
    ...
    __slots__: List[str] = ['__elements', '__address', '__callbacks',
                            '__stride', '__dimensions', '__element_datatype']
    ...
    def __iter__(self) -> Iterator[Union[NodeArrayElementType, NodeArray[NodeArrayElementType]]]:
