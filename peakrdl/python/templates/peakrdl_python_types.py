...
WriteCallback = Callable[[int, int, int, int], type(None)]
...
class Reg(_Node):
    ...
    def width(self) -> int:
        """
        The width of the register, this uses the `regwidth` systemRDL property
    ...
    def accesswidth(self) -> int:
        """
        The access width of the register, this uses the `accesswidth` systemRDL property
...
class RegReadOnly(Reg):
    ...
    def read(self) -> int:
        ...
        """
        return self.__read_callback(addr=self.address,
                                    width=self.width,
...
class RegWriteOnly(Reg):
    ...
    def write(self, data: int) -> NoReturn:
        ...
        self.__write_callback(addr=self.address,
                              width=self.width,
                              accesswidth=self.accesswidth,
                              data=data)
...
class FieldWriteOnly(Field):
    ...
    def write(self, value: int) -> NoReturn:
        ...
        if (self.high == (self.register_data_width - 1)) and \
                (self.low == 0):
